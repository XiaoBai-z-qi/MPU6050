...
{
	HAL_I2C_Mem_Write(OLED_I2C, OLED_ADDRESS, 0x00, I2C_MEMADD_SIZE_8BIT, &Command, 1, 500);
}
...
{
	HAL_I2C_Mem_Write(OLED_I2C, OLED_ADDRESS, 0x40, I2C_MEMADD_SIZE_8BIT, Data, Count, HAL_MAX_DELAY);
}
